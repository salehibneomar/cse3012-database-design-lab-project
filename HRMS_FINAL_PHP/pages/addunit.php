...
if($panel_sys==="1"){
    ...
    if(isset($_POST['insert'])){
        if(empty(trim($_POST['floor'])) || empty(trim($_POST['unit']))){
            $empty=true;
        }
        else{
        ...
        if($empty!=true){
            INSERT($conn,"INSERT INTO unit VALUES('$hid', '$floor', '$unit', 'Free')");
...
<?php include "../includes/nav.php" ?>
    ...
    <section class="sec2">
        <div class="table-con">
            ...
            <h5 class="table-card-title">Add Unit</h5>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="lbl1"><span>&ast;</span>&ensp;Floor</label>
                                <input name="floor" type="text" class="form-control " id="lbl1" placeholder="E.G: First">
                            </div>
                            <div class="form-group">
                                <label for="lbl2"><span>&ast;</span>&ensp;Unit</label>
                                <input  name="unit" type="text" class="form-control " id="lbl2" placeholder="E.G: 101">
                            </div>
